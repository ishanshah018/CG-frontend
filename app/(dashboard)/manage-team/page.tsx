...
try {
    ...
    if (Array.isArray(dataObj.invitations)) {
        invitationsData = dataObj.invitations as PendingInvitation[]
    }
    }
...
if (plan?.name === "growth") return 3
if (plan?.name === "scale") return 5
return 1
}
    ...
    <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start gap-2">
        ...
        {plan?.name === "free" ? (
            ...
            <p className="text-sm text-yellow-700 mt-1">
                Free plan doesn&apos;t support team collaboration. Upgrade to invite team members and work together.{" "}
                <button
                type="button"
            ...
            <p className="text-sm text-yellow-700 mt-1">
                You&apos;ve reached your plan&apos;s member limit ({planLimit} members). Upgrade to add more team members.{" "}
                <button
                type="button"
                onClick={() => router.push("/pricing")}
                className="underline font-medium hover:text-yellow-900"
