...
<div className="min-h-screen flex items-center justify-center bg-surface-canvas px-4">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <input
            type="checkbox"
            id="remember"
            className="w-5 h-5 rounded border-[#66666659] text-brand-primary focus:ring-brand-primary focus:ring-offset-0"
            defaultChecked
        />
        <label
            htmlFor="remember"
        ...
        <button
        type="submit"
        className="w-full h-14 bg-brand-primary hover:bg-brand-primary-hover text-white font-semibold text-lg rounded-full transition-colors"
        >
        Log in
        </button>
    </form>
